...
This is part of my current and ever evolving effort to configure my systems and the software that run on them.
...
On this machine I want to run GNU Guix, because I want to learn about it. The harware in my laptop is non-free so the regular libre-kernel will not boot.
