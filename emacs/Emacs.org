...
Making Emacs have the functionality of an IDE like VSCode. And other things that are related to develoment. TODO: move magit and projectile here ??
...
#+begin_src emacs-lisp :tangle .config/config :noweb yes
  value=<<the-value>>
#+end_src
